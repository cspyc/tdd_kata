...
public class FizzBuzz12Test {
    ...
    public void createNumbersTest() {
        assertThat(100,equalTo(fb12.createNumbers(100).size()));
    }
    ...
    public void isDividedTest() {
        assertThat(true,equalTo(fb12.isDivided("10","2")));
    }
    ...
    public void isContainTest() {
        assertThat(true,equalTo(fb12.isContain("11","1")));
    }

    @Test
    public void isFizzTest() {
        assertThat(true,equalTo(fb12.isFizz("3")));
    }

    @Test
    public void isBuzzTest() {
        assertThat(true,equalTo(fb12.isBuzz("5")));
    }


    @Test
    public void startGameTest() {
        assertThat(speakCode,equalTo(fb12.startGame(numberCode)));
    }
