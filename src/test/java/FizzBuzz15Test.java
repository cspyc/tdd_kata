...
public class FizzBuzz15Test {
    ...
    public void createNumberTest() {
        assertThat(100,equalTo(fb15.createNumbers(100).size()));
    }
    ...
    public void isDividedTest() {
        assertThat(true,equalTo(fb15.isDivided("10","2")));
    }
    ...
    public void isContainTest() {
        assertThat(true,equalTo(fb15.isContain("10","0")));
    }

    @Test
    public void isFizzTest(){
        assertThat(true,equalTo(fb15.isFizz("3")));
    }

    @Test
    public void isBuzzTest() {
        assertThat(true,equalTo(fb15.isBuzz("5")));
    }

    @Test
    public void startGameTest() {
        assertThat(speakCode,equalTo(fb15.startGame(numberCode)));
    }
}
